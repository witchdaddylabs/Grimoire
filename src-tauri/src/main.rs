...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            storyplan_cmds::storyplan_list,
            storyplan_cmds::storyplan_create,
            storyplan_cmds::storyplan_get,
            storyplan_cmds::storyplan_update,
            storyplan_cmds::storyplan_delete,
            storyplan_cmds::storyplan_scene_create,
            storyplan_cmds::storyplan_scene_update,
            storyplan_cmds::storyplan_scene_delete,
            storyplan_cmds::storyplan_beat_create,
            storyplan_cmds::storyplan_beat_update,
            storyplan_cmds::storyplan_beat_delete,
            storyplan_cmds::storyplan_beat_lock,
            storyplan_cmds::storyplan_reorder,
